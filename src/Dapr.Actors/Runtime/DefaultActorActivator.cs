...
namespace Dapr.Actors.Runtime
{
    ...
    public class DefaultActorActivator : ActorActivator
    {
        ...
        /// </summary>
        /// <param name="service">The actor service specifying information needed for the creation of the actor.</param>
        /// <returns>
        ...
        /// </remarks>
        public override Task<ActorActivatorState> CreateAsync(ActorService service)
        {
            var type = service.ActorTypeInfo.ImplementationType;
            var actor = (Actor)Activator.CreateInstance(type, args: new object[]{ service, });
